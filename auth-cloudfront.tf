...
### The CloudFront Distributions here are only used if authentication is enabled ###

### www Distribution ###
resource "aws_cloudfront_distribution" "auth_static_site" {
  # Only include the resource is var.enable_auth is used
...
resource "aws_cloudfront_distribution" "auth_static_site_redirect" {
